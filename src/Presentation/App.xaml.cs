...
public partial class App : Application
{
    ...
    public static void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<ILicenseSourceReader, FileLicenseSourceReader>();
        services.AddSingleton<IHardwareIdProvider, WindowsHardwareIdProvider>();
        services.AddSingleton<ILicenseSignatureVerifier, LegacyLicenseSignatureVerifier>();
        services.AddSingleton<ILicenseService, LicenseService>();
        services.AddSingleton<IBarcodeImageEncoder, ZxingBarcodeImageEncoder>();
        services.AddSingleton<IBarcodeService, BarcodeService>();
        services.AddSingleton<ILabelTemplateProvider, ManagedLabelTemplateProvider>();
        services.AddSingleton<ILabelDocumentRenderer, NativeLabelDocumentRenderer>();
        services.AddSingleton<ILabelPrinter, WindowsLabelPrinter>();
        services.AddSingleton<ILabelOutputWorkflow, LabelOutputWorkflow>();
        services.AddSingleton<ILabelPreviewDialogService, LabelPreviewDialogService>();
        ...
        services.AddSingleton<ITemplateCatalog, ManagedTemplateCatalog>();
        services.AddSingleton<IConfigurationRecoveryService, ConfigurationRecoveryService>();
        services.AddTransient<IConfigurationEditorWorkflow, ConfigurationEditorWorkflow>();
        services.AddTransient<ConfigurationViewModel>();
        services.AddSingleton<IConfigurationFilePicker, WpfConfigurationFilePicker>();
