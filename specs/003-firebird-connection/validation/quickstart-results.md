...
| 5. Integración controlada | PASS | 10 conexiones reales consecutivas exitosas contra la configuración autorizada. |
...
dialecto `3`, timeout `5` y pooling habilitado. Las variables sensibles se
definieron solo durante la ejecución autorizada y se limpiaron al terminar.
